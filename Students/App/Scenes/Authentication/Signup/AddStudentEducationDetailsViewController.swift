//
//  AddStudentEducationDetailsViewController.swift
//  Students
//
...
class AddStudentEducationDetailsViewController: BaseViewController {
    ...
    @IBAction func didTapCTAButton(_ sender: Any) {
        let viewController = AddStudyingSubjectViewController.getInstance()
        navigationController?.pushViewController(viewController, animated: true)
    }
}

extension AddStudentEducationDetailsViewController {
...
extension AddStudentEducationDetailsViewController: Initializable {
