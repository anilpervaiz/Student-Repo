...
internal enum Asset {
  ...
  internal enum Media {
    ...
    internal static let closeCircular = ImageAsset(name: "closeCircular")
    internal static let filter = ImageAsset(name: "filter")
    internal static let addCircular = ImageAsset(name: "addCircular")
    internal static let findByEmail = ImageAsset(name: "findByEmail")
    internal static let newAccount = ImageAsset(name: "newAccount")
    ...
    internal static let mySessions = ImageAsset(name: "mySessions")
    internal static let myWallet = ImageAsset(name: "myWallet")
    ...
    internal static let tabbarLinkedAccountNormal = ImageAsset(name: "tabbarLinkedAccountNormal")
    internal static let tabbarLinkedAccountSelected = ImageAsset(name: "tabbarLinkedAccountSelected")
    ...
    internal static let subjectGray = ImageAsset(name: "subjectGray")
    ...
    internal static let radioButtonSelectedWhite = ImageAsset(name: "radioButtonSelectedWhite")
